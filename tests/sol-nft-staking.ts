...
describe("sol-nft-staking", async() => {
  ...
  console.log("rewarderBump->",rewarderBump);
  ...
  console.log("rewardAuthority->",rewardAuthority);
  console.log("rewardAuthorityBump->",rewardAuthorityBump);
  ...
  console.log("stakeAccountBump->",stakeAccountBump);

  const rewardRate = 100;
  const lockingPeriod = 7;
  let rewardMint = null;
